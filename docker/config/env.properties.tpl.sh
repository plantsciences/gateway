...
# Must stay comfortably below the ALB idle_timeout (deploy/master.tf) so heartbeat
# traffic keeps the connection warm instead of the load balancer killing it first.
gateway.socketio.interval=25
...
gateway.rabbitmq.durable=$RABBIT_DURABLE
